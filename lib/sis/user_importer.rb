...
module SIS
  class UserImporter < BaseImporter
    ...
    class Work
      ...
      def add_user(user_id, login_id, first_name, last_name, email, status, provider, password=nil,  ssha_password=nil, integration_id=nil)
        @logger.debug("Processing User #{[user_id, login_id, password, first_name, last_name, email, status, provider, ssha_password,integration_id].inspect}")
        ...
        @batched_users << [user_id.to_s, login_id, password, first_name, last_name, email, status, provider, ssha_password, integration_id]
      ...
      def process_batch
        ...
        User.transaction do
          ...
          while !@batched_users.empty? && tx_end_time > Time.now
            ...
            user_id, login_id, password, first_name, last_name, email, status , provider, ssha_password,integration_id = user_row
