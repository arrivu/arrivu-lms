    ...
    unless @current_user.nil?
      ...
      unless context_external_tool.nil?
        ...
        unless @badge_ex_tool.nil?
          ...
          @launch = BasicLTI::ToolLaunch.new(:url => @resource_url_for_main_nav, :tool => @badge_ex_tool, :user => @current_user, :context => badge_context, :link_code => @opaque_id, :return_url => @return_url, :resource_type => @resource_type)
