...
class User < ActiveRecord::Base
  ...
  has_many :associated_sub_accounts, :source => :account, :through => :user_account_associations, :order => 'user_account_associations.depth', :conditions => 'accounts.parent_account_id IS NOT NULL'
