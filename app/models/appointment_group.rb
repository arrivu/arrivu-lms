...
class AppointmentGroup < ActiveRecord::Base
  ...
  attr_accessible :title, :description, :location_name, :location_address, :contexts, :sub_context_codes,
                  :participants_per_appointment, :min_appointments_per_participant, :max_appointments_per_participant,
                  :new_appointments, :participant_visibility, :cancel_reason,:is_for_live_conference,:live_conference_type
