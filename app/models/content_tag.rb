...
class ContentTag < ActiveRecord::Base
  ...
  FLIP_CLASS_TYPES = [PRE_CLASS_VIDEO,PRE_CLASS_RECORDING,PRE_CLASS_PRESENTATION,PRE_CLASS_ASSIGNMENTS,PRE_CLASS_READING_MATERIALS]

  PRE_CLASS_VIDEO_POSITION = 1
  PRE_CLASS_RECORDING_POSITION = 2
  PRE_CLASS_PRESENTATION_POSITION = 3
  PRE_CLASS_ASSIGNMENTS_POSITION = 5
  PRE_CLASS_READING_MATERIALS_POSITION = 4
