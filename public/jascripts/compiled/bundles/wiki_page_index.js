...
(function() {
  ...
  require(['i18n!pages', 'str/htmlEscape', 'compiled/collections/WikiPageCollection', 'compiled/views/wiki/WikiPageIndexView'], function(I18n, htmlEscape, WikiPageCollection, WikiPageIndexView) {
    var deleted_page_title, view;
    deleted_page_title = $.cookie('deleted_page_title');
    if (deleted_page_title) {
      $.cookie('deleted_page_title', null, {
        path: '/'
      });
      $.flashMessage(htmlEscape(I18n.t('notices.page_deleted', 'The page "%{title}" has been deleted.', {
