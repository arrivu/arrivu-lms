$(function() {
    ...
    var protocol_and_host = ENV.BADGEHOSTWITHPORT;
//    var $scripts = $("script");
...
//    });
    if(!protocol_and_host) {
        console.log("Couldn't find a valid protocol and host. Arrivu badges will not appear on profile pages until this is fixed.");
    }
